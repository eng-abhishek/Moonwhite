  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createStores', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addModal">Add Stores</button>
          <br /> <br />
        <?php endif; ?>
          ...
          <div class="box-body">
            <table id="manageTable" class="table table-bordered table-striped">
              ...
              <tr>
                <th>Store Name</th>
                <th>Status</th>
                <?php if(in_array('updateStores', $user_permission) || in_array('deleteStores', $user_permission)): ?>
                  <th>Action</th>
                <?php endif; ?>
              </tr>
              </thead>
...
<?php if(in_array('updateStores', $user_permission)): ?>
<!-- edit brand modal -->
...
<?php if(in_array('deleteStores', $user_permission)): ?>
<!-- remove brand modal -->
