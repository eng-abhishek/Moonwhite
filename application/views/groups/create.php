  ...
  <td> - </td>
                     ...
                     <tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewOrderReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                       ...
                       <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewProfitReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                       ...
                       <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewProfitShareReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewLedgerReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewInventoryReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewSalseReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewDueReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                       ...
                       <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewAccountReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewInvoiceReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewBalanceReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewProductModelReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewExpensesReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewConsolidatedReports" class="minimal"></td>
                        <td> - </td>
                      </tr>
