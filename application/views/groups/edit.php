                  ...
                  <table class="table table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewOrderReports" <?php if($serialize_permission) {
                          if(in_array('viewOrderReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                        </tr>
                       ...
                       <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewProfitReports" <?php if($serialize_permission) {
                          if(in_array('viewProfitReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>

                       <tr>
                        <td>Profit Share Report</td>
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewProfitShareReports" <?php if($serialize_permission) {
                          if(in_array('viewProfitShareReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewLedgerReports" <?php if($serialize_permission) {
                          if(in_array('viewLedgerReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewInventoryReports" <?php if($serialize_permission) {
                          if(in_array('viewInventoryReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewSalseReports" <?php if($serialize_permission) {
                          if(in_array('viewSalseReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewDueReports" <?php if($serialize_permission) {
                          if(in_array('viewDueReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                       ...
                       <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewAccountReports" <?php if($serialize_permission) {
                          if(in_array('viewAccountReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewInvoiceReports" <?php if($serialize_permission) {
                          if(in_array('viewInvoiceReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewBalanceReports" <?php if($serialize_permission) {
                          if(in_array('viewBalanceReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>

                      <tr>
                        <td>Product Model Report</td>
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewProductModelReports" <?php if($serialize_permission) {
                          if(in_array('viewProductModelReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewExpensesReports" <?php if($serialize_permission) {
                          if(in_array('viewExpensesReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td> - </td>
                        <td> - </td>
                        <td><input type="checkbox" name="permission[]" id="permission" value="viewConsolidatedReports" <?php if($serialize_permission) {
                          if(in_array('viewConsolidatedReports', $serialize_permission)) { echo "checked"; } 
                        } ?> class="minimal"></td>
                        <td> - </td>
                      </tr>
