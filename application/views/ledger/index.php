    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <div class="box">
          ...
          <form method="post" action="<?php echo base_url('ledger/exportLedgerData');?>">
          <div class="row">
          <div class="col-sm-2"></div>
          <div class="col-sm-2">
          <input type="text" name="fromDate" placeholder="From Date" id="from_date" class="form-control">
          </div>
          <div class="col-sm-2">
          <input type="text" name="toDate" placeholder="To Date" id="to_date" class="form-control">
          </div>
          <div class="col-sm-2">
