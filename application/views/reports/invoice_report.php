  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
       ...
       <div class="box">
          <div class="box-header">
            <h3 class="box-title">Invoice Sales Report</h3>
          </div>
      <!--  <div><a href="javascript:void(0)" onclick="downloadAdvanceInvoice()">PDF</a></div> -->
          ...
          <div class="box-body">
          <div class="row">
          <form method="post" id="invoiceForm" action="<?php echo base_url('reports/exportInvoiceSalesReportList');?>">  
...
$('#invoiceForm').submit(function(){
  ...
  if( (yearID!='' && monthID=='') || (yearID=='' && monthID!='')){
...
function getAccountData(){
  ...
  $.ajax({
  url:'<?php echo base_url('reports/getInvoiceSalesReportList');?>',
  method:'POST',
  data:{monthID:monthID,yearID:yearID,custID:custID,payID:payID},
