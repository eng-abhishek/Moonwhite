 ...
 display:none;
           ...
           //   echo"<pre>";
              ...
              <tr>
                ...
                <td><?php if($value_two['paid_status']=='2'){ echo"NOT"; }elseif($value_two['paid_status']=='3'){ echo"FOC";}elseif($value_two['paid_status']=='4'){ echo"CANCELLED";}elseif($value_two['paid_status']=='1'){ echo"RECEIVED";}else{ } ;?></td>
