    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
       ...
       <div class="box">
          ...
          <!-- /.box-header -->
          <div class="box-body">
          <form method="post" action="<?php echo base_url('reports/exportconsolidatedDataList');?>">
          <div class="row">
          ...
          <select name="monthID" id="monthID" class="form-control" required="">
...
function getAccountData(){
  ...
  $.ajax({
  url:'<?php echo base_url('reports/getConsolidateDataList');?>',
  method:'POST',
