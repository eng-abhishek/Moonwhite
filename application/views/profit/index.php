    ...
    <section class="content">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-xs-12">
          <form class="form-inline" action="<?php echo base_url('profit/') ?>" method="POST">
        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Total Paid Orders - Profit Data</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            echo round($amount_calc,2).' '.$date_format['currency'];
            }else{
            echo $date_format['currency'].' '.round($amount_calc,2);
            }?>                 
                      </td>
                    </tr>
                  <?php endforeach ?>                  
            ...
            echo round(array_sum($total_profit),2).' '.$date_format['currency'];
            }else{

            echo $date_format['currency'].' '.round(array_sum($total_profit),2);
            }?>
  ...
  <script type="text/javascript">
    ...
    var report_expense_data = '';

    console.log("report_data : "+ report_data);

    var absDifference = (arr1, arr2) => {
       const res = [];
      ...
      datasets: [
        {
          ...
          data                : absDifference(report_data, report_expense_data)
        }
      ]
    }
