        ...
        <div class="box">
          ...
          <form role="form" action="<?php base_url('orders/create') ?>" method="post" class="form-horizontal">
              <div class="box-body">
                ...
                <div class="col-md-12 col-xs-12 pull pull-left">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                     ...
                     <select class="form-control select_group customer_name" data-row-id="row_1" id="customer_name" name="customer_name" required="" style="width:100%;">
                              <option value="">~~Select~~</option>
                              <?php foreach ($customers as $k => $v): ?>
                              <option value="<?php echo $v['id'] ?>" cust_address="<?php echo $v['address'] ?>" cust_phone="<?php echo $v['contact'] ?>"><?php echo $v['code'].'-'.$v['name']; ?></option>
                            <?php endforeach ?>
                      </select>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="due_days" class="col-sm-5 control-label" style="text-align:left;">Terms</label>
                    <div class="col-sm-7">
                ...
                <table class="table table-bordered" id="product_info_table">
                  <thead>
                   ...
                   <tbody>
                     <tr id="row_1" class="qty_row">
                       <td>
                          <select class="form-control select_group product" data-row-id="row_1" id="product_1" name="product[]" style="width:100%;" onchange="getProductData(1)" required>
                            <option value="">-- Select --</option>
                            <?php foreach ($products as $k => $v): ?>
                                <?php $des=str_replace(' ','',$v['description']);?>
                              <option value="<?php echo $v['id'] ?>"><?php echo $v['model_no'].'-'.$v['color'].'-'.$des.'-'.$v['qty'].' '.'qty avaliable';?></option>
                            <?php endforeach ?>
                          </select>
                        </td>
                        <td><input type="text" name="qty[]" id="qty_1" class="form-control" required onkeyup="getTotal(1)"></td>
                        <td>
                          <input type="text" name="rate[]" id="rate_1" onkeyup="onkeyup_rate_01()" class="form-control" autocomplete="off">
                      ...
                      <td>                          
                        <input type="text" name="discount[]" id="discount_1" class="form-control" autocomplete="off" onkeyup="getDiscountTotal(1)">
                 ...
                 <!--  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <input type="text" class="form-control" id="total_discount" name="total_discount" autocomplete="off" readonly>
                   ...
                   <div class="form-group">
                    ...
                    <div class="col-sm-7">
                     <input type="date" name="order_date" class="form-control" required="" id="paidDateInput">
                    </div>
                    </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-primary" id="createOrder">Create Order</button>
      ...
      $.ajax({
          ...
          success:function(response) {
              ...
              // console.log(reponse.x);
               var html = '<tr id="row_'+row_id+'" class="qty_row">'+
                   '<td>'+ 
                    ...
                    '<td><input type="text" name="rate[]" onkeyup="onkeyup_rate('+row_id+')" id="rate_'+row_id+'" class="form-control"><input type="hidden" name="rate_value[]" id="rate_value_'+row_id+'" class="form-control"></td>'+'<td><input type="text" name="amount[]" id="amount_'+row_id+'" class="form-control" disabled><input type="hidden" name="amount_value[]" id="amount_value_'+row_id+'" class="form-control"></td>'+ 
    ...
    if(product_id == "") {
      ...
      $.ajax({
        ...
        success:function(response) {
          ...
          $("#rate_"+row_id).val(response.price_selling);
          $("#rate_value_"+row_id).val(response.price_selling);

          $("#qty_"+row_id).val(1);
          $("#qty_value_"+row_id).val(1);

          var total = Number(response.price_selling) * 1;
          total = total.toFixed(2);
...
function onkeyup_rate_01(){
var rate_1=$('#rate_1').val();
var qty_1=$('#qty_1').val();
$('#rate_value_1').val(rate_1);

var total_amt=qty_1*rate_1;
$('#amount_1').val(total_amt);
$('#amount_value_1').val(total_amt);
$('#subtotal_1').val(total_amt);
