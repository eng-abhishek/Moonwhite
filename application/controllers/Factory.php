...
class Factory extends Admin_Controller 
{
    ...
    */
	public function create()
	{
		...
		$this->form_validation->set_rules('factory_phone', 'Factory Phone', 'trim|required|max_length[15]|min_length[8]|is_unique[factories.phone]');
    ...
    */
	public function update($id)
	{
	    ...
	    if($this->input->post('edit_factory_phone') != $this->input->post('old_factory_phone')) {
		$is_unique_contact =  '|is_unique[factories.phone]';
		} else {
		$is_unique_contact =  '';
		}

			$this->form_validation->set_rules('edit_factory_phone', 'Factory Phone', 'trim|required|max_length[15]|min_length[8]'.$is_unique_contact);
